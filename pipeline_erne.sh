...
./testcase-bs-aligner-default.sh /home/nicola/workspace/datasets/genomes/hg19/ucsc.hg19.fasta $wd
...
erne-meth --fasta /home/nicola/workspace/datasets/genomes/hg19/ucsc.hg19.fasta --input $wd/erne_bs5_out.bam --output-prefix $wd/erne_meth_out --annotations-bismark
